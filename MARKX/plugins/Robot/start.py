...
from MARKX import Telegram, YouTube, app
from MARKX.misc import SUDOERS
from MARKX.plugins.Robot.playlist import del_plist_msg
from MARKX.plugins.Robot.sudoers import sudoers_list
from MARKX.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
...
from MARKX.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgEAAx0CYI0AAQEAAkaHY3H6OXSkGcgFtYK9QM3RZCHhueMAAusDAAJjRnBHGBV-f-ragZ4eBA")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/xSupport_ies) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text=" sᴜᴩᴩᴏʀᴛ ", url="https://t.me/xSupport_ies"
                        ),
                    ],
                ]
            )

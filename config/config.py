...
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://lakshya:lakshya@cluster0.lgv5pyy.mongodb.net/?retryWrites=true&w=majority")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
     "https://github.com/LaKsH-X/LakshyaMuxic",
)
